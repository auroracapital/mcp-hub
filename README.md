...
- [auroracapital/upres-cli](https://github.com/auroracapital/upres-cli) <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg" width="16" height="16"/> 🏠 ☁️ - AI image and video upscaler to 8K resolution across 14 public model aliases with batch processing, REST API, and MCP server support
